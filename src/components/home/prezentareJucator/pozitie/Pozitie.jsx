...
const Pozitie = ({ playerDetails }) => {
  const descrierePozitie = {
    portar: 'Jucătorul ce ocupă poziția de portar reprezintă ultima linie de apărare și este responsabil de protejarea porții, împiedicând adversarii să marcheze.',
    'inter-stanga': 'Interii sunt jucători versatili, ocupând zone centrale ale terenului și având responsabilități atât în atac, cât și în apărare.',
    'inter-dreapta': 'Interii sunt jucători versatili, ocupând zone centrale ale terenului și având responsabilități atât în atac, cât și în apărare.',
    pivot: 'Pivotul ocupă poziția centrală în atac, având rolul de a atașa mingea și de a crea oportunități pentru colegii de echipă.',
    'extrema-stanga': 'Jucătorii de pe pozițiile extreme sunt responsabili pentru marcarea golurilor și pentru participarea activă la construcția atacului echipei.',
    'extrema-dreapta': 'Jucătorii de pe pozițiile extreme sunt responsabili pentru marcarea golurilor și pentru participarea activă la construcția atacului echipei.',
